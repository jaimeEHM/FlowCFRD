...
<template>
    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        <Heading
            ...
            description="Administra la configuración de autenticación de dos factores (2FA)"
        />
        ...
        >
            <p class="text-sm text-muted-foreground">
                ...
                seguro al iniciar sesión. Puedes obtenerlo en una aplicación
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                ...
                puedes obtener en la aplicación compatible con TOTP de tu
                teléfono.
            </p>
