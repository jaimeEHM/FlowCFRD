...
ensure_vite_manifest() {
  ...
  # Fallback por bug de npm con opcionales nativos (Rollup/Rolldown) en algunas plataformas.
  npm install --save-optional \
    @rolldown/binding-linux-arm64-gnu@latest \
    @rolldown/binding-linux-x64-gnu@latest \
    @rolldown/binding-darwin-arm64@latest \
